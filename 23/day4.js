...
import { magic, multiMapFilterEach, multiSplit, readFileLines } from '../utils/index.js'

magic()
const data = readFileLines('data/day4.txt')

let sum = 0
for (const line of data) {
    const [, game, rest] = line.match(/^Card +(\d+): (.*)$/)
